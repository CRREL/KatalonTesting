...
class GRiDListener {
	...
	def sampleBeforeTestSuite(TestSuiteContext testSuiteContext) {
		...
		if (testSuiteContext.getTestSuiteId().contains("GRiD FG3D")) {
		...
		if (testSuiteContext.getTestSuiteId().contains("AFE Test Suite")) {
		...
		if (testSuiteContext.getTestSuiteId().contains("GRiD LegacyExports")) {
