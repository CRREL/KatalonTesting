...
/**
	 * Refresh browser
	 */
def static "modelsKeywords.refreshBrowser"() {
    (new modelsKeywords()).refreshBrowser()
}
...
/**
	 ...
	 */
def static "modelsKeywords.clickElement"(
    	TestObject to	) {
    (new modelsKeywords()).clickElement(
        	to)
}
...
/**
	 ...
	 */
def static "modelsKeywords.getHtmlTableRows"(
    	TestObject table	
     , 	String outerTagName	) {
    (new modelsKeywords()).getHtmlTableRows(
        	table
         , 	outerTagName)
}
