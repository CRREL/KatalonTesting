...
WebUI.click(findTestObject('Page_Map  GRiD/span_Vricon'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'vricon dsm')

WebUI.click(findTestObject('Page_Map  GRiD/a_Vricon DSM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Vricon DSM AOI Modal Katalon')
