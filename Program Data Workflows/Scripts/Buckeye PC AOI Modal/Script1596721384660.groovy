...
WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/a_Buckeye PC (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Buckeye PC AOI Modal Katalon')
