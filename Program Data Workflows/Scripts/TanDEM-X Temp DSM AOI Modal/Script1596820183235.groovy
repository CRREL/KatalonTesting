...
WebUI.click(findTestObject('Page_Map  GRiD/span_TanDEM-X Temporary'))

WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/span_Digital Surface Model (DSM)'))

WebUI.click(findTestObject('Page_Map  GRiD/Apply Data Layer Filter'))

WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'tdt dsm')

WebUI.click(findTestObject('Page_Map  GRiD/a_TDT DSM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'TDT DSM AOI Modal Katalon')
