...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'usace pc')

WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/a_USACE PC (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'USACE PC AOI Modal Katalon')
