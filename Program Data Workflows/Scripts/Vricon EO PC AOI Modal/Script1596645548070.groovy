...
WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/li_Vricon'))

WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/span_EO Pointcloud'))

WebUI.click(findTestObject('Page_Map  GRiD/Apply Data Layer Filter'))

WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'vricon')

WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/a_VriconPC (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Vricon PC AOI Modal Katalon')
