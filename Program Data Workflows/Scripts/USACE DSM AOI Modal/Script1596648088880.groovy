...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'usace dsm')

WebUI.click(findTestObject('Object Repository/Page_Map  GRiD/a_USACE DSM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'USACE DSM AOI Modal Katalon')
