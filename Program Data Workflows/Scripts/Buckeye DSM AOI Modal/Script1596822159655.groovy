...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'buckeye pc')

WebUI.click(findTestObject('Page_Map  GRiD/a_Buckeye PC (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Buckeye DSM AOI Modal Katalon')
