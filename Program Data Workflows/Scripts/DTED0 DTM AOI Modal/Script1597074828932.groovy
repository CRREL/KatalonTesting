...
WebUI.click(findTestObject('Page_Map  GRiD/span_DTED0'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'dted0 dtm')

WebUI.click(findTestObject('Page_Map  GRiD/a_DTED0 DTM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'DTED0 DTM AOI Modal Katalon')
