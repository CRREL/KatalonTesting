...
WebUI.click(findTestObject('Page_Map  GRiD/span_Electro-Optical (EO) Image'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Buckeye Imagery AOI Modal Katalon')
