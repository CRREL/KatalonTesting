...
WebUI.click(findTestObject('Page_Map  GRiD/View Vector Data Layer GRiD Map'))

WebUI.click(findTestObject('Page_Map  GRiD/Filter Vector Data Layer GRiD Map'))

WebUI.click(findTestObject('Page_Map  GRiD/span_US Cities'))

WebUI.click(findTestObject('Page_Map  GRiD/Apply Data Layer Filter'))

WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'usc vectors')

WebUI.click(findTestObject('Page_Map  GRiD/a_USC Vectors (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'US Cities Vectors AOI Modal Katalon')
