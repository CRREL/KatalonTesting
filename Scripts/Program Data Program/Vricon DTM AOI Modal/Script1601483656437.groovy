...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'vricon dtm')

WebUI.click(findTestObject('Page_Map  GRiD/a_Vricon DTM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'Vricon DTM AOI Modal Katalon')
