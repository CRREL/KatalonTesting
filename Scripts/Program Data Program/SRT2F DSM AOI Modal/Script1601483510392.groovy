...
WebUI.click(findTestObject('Page_Map  GRiD/span_SRT2F'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'SRT2F DSM')

WebUI.click(findTestObject('Page_Map  GRiD/a_SRT2F DSM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'SRT2F DSM AOI Modal Katalon')
