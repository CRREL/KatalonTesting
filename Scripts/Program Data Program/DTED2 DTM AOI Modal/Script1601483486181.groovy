...
WebUI.click(findTestObject('Page_Map  GRiD/span_DTED2'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Map Search'), 'dted2 dtm')

WebUI.click(findTestObject('Page_Map  GRiD/a_DTED2 DTM (AOI)'))
...
WebUI.setText(findTestObject('Page_Map  GRiD/Export Name AOI Modal'), 'DTED2 DTM AOI Modal Katalon')
