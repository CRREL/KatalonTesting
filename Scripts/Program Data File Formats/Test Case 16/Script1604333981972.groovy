...
WebUI.click(findTestObject('Page_Map  GRiD/Imagery filter'))

WebUI.click(findTestObject('Page_Map  GRiD/span_Artemis'))

WebUI.click(findTestObject('Page_Map  GRiD/span_EO - Orthorectified'))
...
WebUI.click(findTestObject('Page_Map  GRiD/a_Artemis EO (AOI)'))
