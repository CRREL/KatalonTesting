...
WebUI.navigateToUrl('https://grid.nga.mil/grid/accounts/login/?next=/grid/export/aoi/38118/')
...
WebUI.click(findTestObject('Object Repository/Page_AT-Vectors  GRiD/button_Generate'))
