...
WebUI.click(findTestObject('Page_USGS PC  GRiD/a_Export pointcloud data'))

WebUI.click(findTestObject('Page_USGS PC  GRiD/div_PC USGS_20100408-0510 UNCLASSIFIED 2010_1266e1'))

WebUI.click(findTestObject('Object Repository/Page_USGS PC  GRiD/svg_Filters_svg-inline--fa fa-caret-right f_d4bc64'))

WebUI.click(findTestObject('Page_USGS PC  GRiD/input_Feature Extraction_filter_afe'))

WebUI.selectOptionByValue(findTestObject('Page_USGS PC  GRiD/select_PSU 190  TexPert 315-3  SRI 15'), 'texpert_3.1.5-3;', 
    true)
