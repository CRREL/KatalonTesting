...
WebUI.selectOptionByValue(findTestObject('Page_AFE  GRiD/select_PSU 190  TexPert 315-3  SRI 15'), 'psu_1.9.0;', true)

Thread.sleep(2000)

WebUI.scrollToElement(findTestObject('Page_AFE  GRiD/label_CDB'), 0)
